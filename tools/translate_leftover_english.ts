// Name: Translate Leftover English
// Description: Translate leftover English text in translated Thai HTML files to Thai
...
- Did I skip any lines in files with multiple target lines (e.g., 'books/133.html')?`,
  ...
  execSync(
    `opencode run "Translate leftover English text to Thai" --model ${appConfig.model.opencode} --agent leftover-translator -- --variant med`,
    {
      stdio: "inherit",
      timeout: 1000 * 60 * 10,
      killSignal: "SIGKILL",
